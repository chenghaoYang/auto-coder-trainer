...
class SFTDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        # FIX: Use single key string for column access to get Series, not DataFrame
        # When prompt_key is a single-element list like ["prompt"],
        # df[["prompt"]] returns DataFrame (no .tolist()), but df["prompt"] returns Series
